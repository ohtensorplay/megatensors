...
See https://mega.tensorplay.cn/docs/hub/eval-results for more details.
...
class EvalResultEntry:
    ...
    Args:
        ...
        source_url (`str`, *optional*):
            Link to the evaluation source (e.g., https://mega.tensorplay.cn/spaces/SaylorTwift/smollm3-mmlu-pro). Required if `source_name`, `source_user`, or `source_org` is provided.
    ...
    Example:
        ```python
        >>> from megatensors._hub import EvalResultEntry
        ...
        ...     source_url="https://mega.tensorplay.cn/datasets/cais/hle",
...
def eval_result_entries_to_yaml(entries: list[EvalResultEntry]) -> list[dict[str, Any]]:
    ...
    Example:
        ```python
        >>> from megatensors._hub import EvalResultEntry, eval_result_entries_to_yaml
        >>> entries = [
        ...
        ```python
        >>> import yaml
        >>> from megatensors._hub import upload_file, EvalResultEntry, eval_result_entries_to_yaml
        >>> entries = [
        ...     EvalResultEntry(dataset_id="cais/hle", task_id="default", value=20.90),
        ... ]
...
def parse_eval_result_entries(data: list[dict[str, Any]]) -> list[EvalResultEntry]:
    ...
    Example:
        ```python
        >>> from megatensors._hub import parse_eval_result_entries
        >>> data = [
