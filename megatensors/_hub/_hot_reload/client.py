...
from ..utils._headers import build_mega_headers
from ..utils._http import mega_raise_for_status
    ...
    def __init__(
        ...
        *,
        ...
        self.client = httpx.Client(
            ...
            headers=build_mega_headers(token=token),
