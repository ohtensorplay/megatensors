...
from megatensors._hub.errors import InferenceEndpointError, InferenceEndpointTimeoutError
...
class InferenceEndpoint:
    ...
    Example:
        ```python
        >>> from megatensors._hub import get_inference_endpoint
    ...
    _api: "MegaApi" = field(repr=False, compare=False)

    @classmethod
    def from_raw(
        cls, raw: dict, namespace: str, token: str | bool | None = None, api: Optional["MegaApi"] = None
    ) -> "InferenceEndpoint":
    ...
    def wait(self, timeout: int | None = None, refresh_every: int = 5) -> "InferenceEndpoint":
        ...
        while True:
            ...
            if self.status == InferenceEndpointStatus.RUNNING and self.url is not None:
                ...
                response = get_session().get(_health_url, headers=self._api._build_mega_headers(token=self._token))
    ...
    def update(
        ...
        *,
        ...
        This is an alias for [`MegaApi.update_inference_endpoint`]. The current object is mutated in place with the
    ...
    def pause(self) -> "InferenceEndpoint":
        ...
        This is an alias for [`MegaApi.pause_inference_endpoint`]. The current object is mutated in place with the
        latest data from the server.
    ...
    def resume(self, running_ok: bool = True) -> "InferenceEndpoint":
        ...
        This is an alias for [`MegaApi.resume_inference_endpoint`]. The current object is mutated in place with the
        latest data from the server.
    ...
    def scale_to_zero(self) -> "InferenceEndpoint":
        ...
        This is an alias for [`MegaApi.scale_to_zero_inference_endpoint`]. The current object is mutated in place with the
        latest data from the server.
    ...
    def delete(self) -> None:
        ...
        This is an alias for [`MegaApi.delete_inference_endpoint`].
        """
