...
class WebhooksServer:
    """
    The [`WebhooksServer`] class lets you create an instance of a Gradio app that can receive MEGA webhooks.
    ...
    Args:
        ...
        webhook_secret (`str`, optional):
            ...
            you also configure it in your [webhooks settings panel](https://mega.tensorplay.cn/settings/webhooks). You
    ...
    Example:
        ...
        ```python
        import gradio as gr
        from megatensors._hub import WebhooksServer, WebhookPayload
    ...
    def launch(self, prevent_thread_lock: bool = False, **launch_kwargs: Any) -> None:
        ...
        message += "\nGo to https://mega.tensorplay.cn/settings/webhooks to setup your webhooks."
        print(message)
    ...
    def _get_default_ui(self) -> "gr.Blocks":
        ...
        with gr.Blocks() as ui:
            ...
            gr.Markdown(
                ...
                " repos, but any repo). Check out this [guide](https://mega.tensorplay.cn/docs/hub/webhooks) to get to"
                " know more about webhooks on the MEGA Hub."
            )
            gr.Markdown(
            ...
            gr.Markdown(
                ...
                if _is_local
                    ...
                    " (top-right) > 'Embed the Space'. The URL looks like 'https://{username}-{repo_name}.mega.space'."
                )
            )
        return ui
...
def webhook_endpoint(path: str | None = None) -> Callable:
    ...
    Examples:
        ...
        ```python
        from megatensors._hub import webhook_endpoint, WebhookPayload
...
def _warn_on_empty_secret(webhook_secret: str | None) -> None:
    if webhook_secret is None:
        ...
        print(
            ...
            " https://mega.tensorplay.cn/docs/hub/webhooks#webhook-secret."
        )
    else:
