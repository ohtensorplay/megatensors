...
See [the Discussions and Pull Requests guide](https://mega.tensorplay.cn/docs/hub/repositories-pull-requests-discussions)
...
class Discussion:
    ...
    Attributes:
        ...
        endpoint (`str`):
            Endpoint of the Hub. Default is https://mega.tensorplay.cn.
