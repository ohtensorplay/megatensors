...
def strict(cls: Type[T] | None = None, *, accept_kwargs: bool = False) -> Type[T] | Callable[[Type[T]], Type[T]]:
    ...
    >>> from megatensors._hub.dataclasses import as_validated_field, strict, validated_field
    ...
    megatensors._hub.errors.StrictDataclassFieldValidationError: Validation error for field 'age':
...
def validate_typed_dict(schema: type[TypedDictType], data: dict) -> None:
    ...
    >>> from megatensors._hub.dataclasses import validate_typed_dict
