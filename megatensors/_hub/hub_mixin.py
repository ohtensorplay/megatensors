...
from .errors import EntryNotFoundError, MegaHubHTTPError
...
# Doc / guide: https://mega.tensorplay.cn/docs/hub/model-cards
{{ card_data }}
---

This model has been pushed to the Hub using the [PytorchModelHubMixin](https://mega.tensorplay.cn/docs/megatensors._hub/package_reference/mixins#megatensors._hub.PyTorchModelHubMixin) integration:
...
class ModelHubMixin:
    ...
    ```python
    >>> from megatensors._hub import ModelHubMixin
    ...
    ...         docs_url="https://mega.tensorplay.cn/docs/my-cool-library",
    ...
    >>> from megatensors._hub import ModelCard
        ...
        **push_to_hub_kwargs,
        ...
        Args:
            ...
            push_to_hub (`bool`, *optional*, defaults to `False`):
                Whether or not to push your model to the MEGA Hub after saving it.
    ...
    def from_pretrained(
        ...
        **model_kwargs,
        ...
        """
        Download a model from the MEGA Hub and instantiate it.
        ...
        Args:
            ...
            token (`str` or `bool`, *optional*):
                ...
                cached when running `mega auth login`.
        ...
        if os.path.isdir(model_id):
            ...
            try:
                ...
                logger.info(f"{constants.CONFIG_NAME} not found on the MEGA Hub: {str(e)}")
    ...
    def _from_pretrained(
        ...
        **model_kwargs,
        ...
        Use [`mega_hub_download`] or [`snapshot_download`] to download files from the Hub before loading them. Most
        ...
        Args:
            model_id (`str`):
                ID of the model to load from the MEGA Hub (e.g. `bigscience/bloom`).
            revision (`str`, *optional*):
    ...
    def push_to_hub(
        ...
        *,
        config: dict | DataclassInstance | None = None,
        commit_message: str = "Push model using megatensors._hub.",
...
class PyTorchModelHubMixin(ModelHubMixin):
    ...
    >>> from megatensors._hub import PyTorchModelHubMixin
