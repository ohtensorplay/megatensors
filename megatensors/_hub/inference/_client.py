...
#
# Related resources:
#    https://mega.tensorplay.cn/tasks
#    https://mega.tensorplay.cn/docs/huggingface.js/inference/README
...
class InferenceClient:
    ...
    def document_question_answering(
        ...
        *,
        ...
        >>> from megatensors._hub import InferenceClient
        >>> client = InferenceClient()
        >>> client.document_question_answering(image="https://mega.tensorplay.cn/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png", question="What is the invoice number?")
    ...
    def text_generation(
        ...
        *,
        ...
        >>> client.text_generation("The megatensors._hub library is ", max_new_tokens=12)
        '100% open source and built to be easy to use.'

        # Case 2: iterate over the generated tokens. Useful for large generation.
        >>> for token in client.text_generation("The megatensors._hub library is ", max_new_tokens=12, stream=True):
        ...     print(token)
        100
        %
        open
        ...
        >>> client.text_generation("The megatensors._hub library is ", max_new_tokens=12, details=True)
        TextGenerationOutput(
        ...
        >>> for details in client.text_generation("The megatensors._hub library is ", max_new_tokens=12, details=True, stream=True):
        ...     print(details)
        ...
    ...
    def get_endpoint_info(self, *, model: str | None = None) -> dict[str, Any]:
        ...
        response = get_session().get(url, headers=build_mega_headers(token=self.token))
        mega_raise_for_status(response)
    ...
    def health_check(self, model: str | None = None) -> bool:
        ...
        ```py
        >>> from megatensors._hub import InferenceClient
        >>> client = InferenceClient("https://jzgu0buei5.us-east-1.aws.endpoints.mega.cloud")
        >>> client.health_check()
        True
        ```
        """
