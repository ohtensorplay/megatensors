...
# https://mega.tensorplay.cn/docs/api-inference/detailed_parameters#text-generation-task.
...
def raise_text_generation_error(http_error: MegaHubHTTPError) -> NoReturn:
    """
    ...
    # If error_type => more information than `mega_raise_for_status`
