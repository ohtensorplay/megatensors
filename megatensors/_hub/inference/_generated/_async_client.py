...
#
# WARNING
# This entire file has been adapted from the sync-client code in `src/megatensors._hub/inference/_client.py`.
...
from megatensors._hub.errors import BadRequestError, MegaHubHTTPError, InferenceTimeoutError
...
from megatensors._hub.inference._generated.types import (
...
from megatensors._hub.inference._providers import PROVIDER_OR_POLICY_T, get_provider_helper
...
from megatensors._hub.utils._auth import get_token
...
class AsyncInferenceClient:
    ...
    Args:
        model (`str`, `optional`):
            The model to run inference with. Can be a model id hosted on the MEGA Hub, e.g. `meta-llama/Meta-Llama-3-8B-Instruct`
            or a URL to a deployed Inference Endpoint. Defaults to None, in which case a recommended model is
            automatically selected for the task.
            Note: for better compatibility with OpenAI's client, `model` has been aliased as `base_url`. Those 2
            arguments are mutually exclusive. If a URL is passed as `model` or `base_url` for chat completion, the `(/v1)/chat/completions` suffix path will be appended to the URL.
        provider (`str`, *optional*):
            Name of the provider to use for inference. Can be `"cerebras"`, `"cohere"`, `"deepinfra"`, `"fal-ai"`, `"featherless-ai"`, `"fireworks-ai"`, `"groq"`, `"mega"`, `"novita"`, `"nscale"`, `"openai"`, `"ovhcloud"`, `"publicai"`, `"replicate"`, `"scaleway"`, `"together"`, `"wavespeed"` or `"zai-org"`.
            Defaults to "auto": automatic routing, which defaults to "fastest" provider; you can
            switch to "cheapest" or "preferred" provider order at https://mega.tensorplay.cn/settings/inference-providers.
            If model is a URL or `base_url` is passed, then `provider` is not used.
        token (`str`, *optional*):
            MEGA token. Will default to the locally saved token if not provided.
    ...
    def __init__(
        ...
        *,
        ...
        if bill_to is not None:
            if (
                constants.MEGA_HEADER_X_BILL_TO in self.headers
                and self.headers[constants.MEGA_HEADER_X_BILL_TO] != bill_to
            ):
                warnings.warn(
                    f"Overriding existing '{self.headers[constants.MEGA_HEADER_X_BILL_TO]}' value in headers with '{bill_to}'.",
                    UserWarning,
                )
            self.headers[constants.MEGA_HEADER_X_BILL_TO] = bill_to

            if token is not None and not token.startswith("mega_"):
                warnings.warn(
                    "You've provided an external provider's API key, so requests will be billed directly by the provider. "
                    "The `bill_to` parameter is only applicable for MEGA billing and will be ignored.",
                    UserWarning,
                )
        ...
        *,
        ...
        Args:
            audio (Union[str, Path, bytes, BinaryIO]):
                ...
                audio file.
            model (`str`, *optional*):
                The model to use for audio classification. Can be a model ID hosted on the MEGA Hub
        ...
        >>> from megatensors._hub import AsyncInferenceClient
        ...
        *,
        ...
        Args:
            audio (Union[str, Path, bytes, BinaryIO]):
                ...
                audio file.
            model (`str`, *optional*):
                The model can be any model which takes an audio file and returns another audio file. Can be a model ID hosted on the MEGA Hub
                or a URL to a deployed Inference Endpoint. If not provided, the default recommended model for
    ...
    async def automatic_speech_recognition(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for ASR. Can be a model ID hosted on the MEGA Hub or a URL to a deployed
    ...
    async def chat_completion(
        ...
        *,
        ...
        > Check out the [Inference guide](https://mega.tensorplay.cn/docs/megatensors._hub/guides/inference#openai-compatibility)
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for chat-completion. Can be a model ID hosted on the MEGA Hub or a URL to a deployed
                Inference Endpoint. If not provided, the default recommended model for chat-based text-generation will be used.
                See https://mega.tensorplay.cn/tasks/text-generation for more details.
        ...
        ```py
        >>> from megatensors._hub import InferenceClient
        ...
        Example using a third-party provider through MEGA Routing. Usage will be billed on your MEGA account.
        ```py
        >>> from megatensors._hub import InferenceClient
        >>> client = InferenceClient(
        ...     provider="novita",  # Use Novita provider
        ...     api_key="mega_...",  # Pass your MEGA token
        ... )
        >>> client.chat_completion(
        ...     model="meta-llama/Meta-Llama-3-8B-Instruct",
        ...     messages=[{"role": "user", "content": "What is the capital of France?"}],
    ...
    async def document_question_answering(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the document question answering task. Can be a model ID hosted on the MEGA Hub or a URL to
        ...
        >>> from megatensors._hub import AsyncInferenceClient
        >>> client = AsyncInferenceClient()
        >>> await client.document_question_answering(image="https://mega.tensorplay.cn/spaces/impira/docquery/resolve/2359223c1837a7587402bda0f2643382a6eefeab/invoice.png", question="What is the invoice number?")
    ...
    async def feature_extraction(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the feature extraction task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def fill_mask(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the fill mask task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def image_classification(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for image classification. Can be a model ID hosted on the MEGA Hub or a URL to a
    ...
    async def image_segmentation(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for image segmentation. Can be a model ID hosted on the MEGA Hub or a URL to a
    ...
    async def image_to_image(
        ...
        **kwargs,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for inference. Can be a model ID hosted on the MEGA Hub or a URL to a deployed
    ...
    async def object_detection(
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for object detection. Can be a model ID hosted on the MEGA Hub or a URL to a
    ...
    async def question_answering(
        ...
        *,
        ...
        Args:
            ...
            model (`str`):
                The model to use for the question answering task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def sentence_similarity(
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the sentence similarity task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def table_question_answering(
        ...
        *,
        ...
        Args:
            ...
            model (`str`):
                The model to use for the table-question-answering task. Can be a model ID hosted on the MEGA
    ...
    async def tabular_classification(self, table: dict[str, Any], *, model: str | None = None) -> list[str]:
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the tabular classification task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def tabular_regression(self, table: dict[str, Any], *, model: str | None = None) -> list[float]:
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the tabular regression task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def text_classification(
        ...
        *,
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the text classification task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def text_generation(
        ...
        *,
        ...
        Returns:
            ...
            - if `stream=False` and `details=True`, the generated text is returned with more details as a [`~megatensors._hub.TextGenerationOutput`]
            - if `details=True` and `stream=True`, the generated text is returned token by token as a iterable of [`~megatensors._hub.TextGenerationStreamOutput`]
        ...
        >>> await client.text_generation("The megatensors._hub library is ", max_new_tokens=12)
        '100% open source and built to be easy to use.'

        # Case 2: iterate over the generated tokens. Useful for large generation.
        >>> async for token in await client.text_generation("The megatensors._hub library is ", max_new_tokens=12, stream=True):
        ...     print(token)
        100
        %
        open
        ...
        >>> await client.text_generation("The megatensors._hub library is ", max_new_tokens=12, details=True)
        TextGenerationOutput(
        ...
        >>> async for details in await client.text_generation("The megatensors._hub library is ", max_new_tokens=12, details=True, stream=True):
        ...     print(details)
        ...
        ...
        ...     model="MEGAH4/zephyr-orpo-141b-A35b-v0.1",
        ...     max_new_tokens=100,
        ...
        *,
        ...
        Args:
            ...
            epsilon_cutoff (`float`, *optional*):
                ...
                Desmoothing](https://mega.tensorplay.cn/papers/2210.15191) for more details.
            ...
            num_beam_groups (`int`, *optional*):
                ...
                See [this paper](https://mega.tensorplay.cn/papers/1610.02424) for more details.
            ...
            typical_p (`float`, *optional*):
                ...
                paper](https://mega.tensorplay.cn/papers/2202.00666) for more details.
        ...
        *,
        ...
        Args:
            text (`str`):
                A string to be classified.
            model (`str`, *optional*):
                The model to use for the token classification task. Can be a model ID hosted on the MEGA Hub or a URL to
    ...
    async def translation(
        ...
        *,
        ...
        Check out https://mega.tensorplay.cn/tasks/translation for more information on how to choose the best model for
        ...
        Args:
            ...
            model (`str`, *optional*):
                The model to use for the translation task. Can be a model ID hosted on the MEGA Hub or a URL to
        ...
        *,
        ...
        Args:
            ...
            question (`str`):
                Question to be answered.
            model (`str`, *optional*):
                The model to use for the visual question answering task. Can be a model ID hosted on the MEGA Hub or a URL to
        ...
        ...     image="https://mega.tensorplay.cn/datasets/mishig/sample_images/resolve/main/tiger.jpg",
    ...
    async def get_endpoint_info(self, *, model: str | None = None) -> dict[str, Any]:
        ...
        client = await self._get_async_client()
        response = await client.get(url, headers=build_mega_headers(token=self.token))
        mega_raise_for_status(response)
    ...
    async def health_check(self, model: str | None = None) -> bool:
        ...
        # Must be run in an async context
        >>> from megatensors._hub import AsyncInferenceClient
        >>> client = AsyncInferenceClient("https://jzgu0buei5.us-east-1.aws.endpoints.mega.cloud")
