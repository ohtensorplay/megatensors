...
from megatensors._hub import snapshot_download
from megatensors._hub.errors import EntryNotFoundError
...
def _load_agent_config(agent_path: Optional[str]) -> tuple[AgentConfig, Optional[str]]:
    ...
    try:
        ...
        raise EntryNotFoundError(
            f" Agent {agent_path} not found in tiny-agents/tiny-agents! Please make sure it exists in https://mega.tensorplay.cn/datasets/tiny-agents/tiny-agents."
        ) from err
