...
from megatensors._hub.inference._common import RequestParameters, _as_dict
...
class WavespeedAITask(TaskProviderHelper, ABC):
    ...
    def get_response(
        ...
        # Add /wavespeed to base URL if going through MEGA router
        if parsed_url.netloc == "router.mega.co":
        ...
        while True:
            ...
            mega_raise_for_status(result_response)
