...
from megatensors._hub.utils import logging, yaml_dump
...
class EvalResult:
    ...
    Args:
        ...
        dataset_type (`str`):
            The dataset identifier. Example: "common_voice". Use dataset id from https://mega.tensorplay.cn/datasets.
        dataset_name (`str`):
            A pretty name for the dataset. Example: "Common Voice (French)".
        metric_type (`str`):
            The metric identifier. Example: "wer". Use metric id from https://mega.tensorplay.cn/metrics.
        metric_value (`Any`):
        ...
        dataset_config (`str`, *optional*):
            ...
            https://mega.tensorplay.cn/docs/datasets/package_reference/loading_methods#datasets.load_dataset.name
        ...
        metric_config (`str`, *optional*):
            ...
            See the `datasets` docs for more info: https://mega.tensorplay.cn/docs/datasets/v2.1.0/en/loading#load-configurations
        ...
        source_url (`str`, *optional*):
            The URL of the source of the evaluation result. Example: "https://mega.tensorplay.cn/spaces/open-llm-leaderboard/open_llm_leaderboard".
    """
    ...
    # Example: common_voice. Use dataset id from https://mega.tensorplay.cn/datasets
    dataset_type: str
    ...
    # Example: wer. Use metric id from https://mega.tensorplay.cn/metrics
    metric_type: str
    ...
    # Example: https://mega.tensorplay.cn/spaces/open-llm-leaderboard/open_llm_leaderboard
    ...
    def is_equal_except_value(self, other: "EvalResult") -> bool:
        ...
        for key, _ in self.__dict__.items():
            if key == "metric_value":
                continue
            # For metrics computed by MEGA's evaluation service, `verify_token` is derived from `metric_value`,
...
class ModelCardData(CardData):
    """Model Card Metadata that is used by MEGA Hub when included at the top of your README.md
    ...
    Args:
        ...
        datasets (`Union[str, list[str]]`, *optional*):
            ...
            found on https://mega.tensorplay.cn/datasets. Defaults to None.
        eval_results (`Union[list[EvalResult], EvalResult]`, *optional*):
            List of `megatensors._hub.EvalResult` that define evaluation results of the model. If provided,
        ...
        license (`str`, *optional*):
            ...
            https://mega.tensorplay.cn/docs/hub/repositories-licenses. Defaults to None.
        ...
        metrics (`list[str]`, *optional*):
            ...
            at https://mega.tensorplay.cn/metrics. Example: 'accuracy'. Defaults to None.
    ...
    Example:
        ```python
        >>> from megatensors._hub import ModelCardData
...
class DatasetCardData(CardData):
    """Dataset Card Metadata that is used by MEGA Hub when included at the top of your README.md
    ...
    Args:
        ...
        license (`Union[str, list[str]]`, *optional*):
            ...
            https://mega.tensorplay.cn/docs/hub/repositories-licenses.
...
class SpaceCardData(CardData):
    """Space Card Metadata that is used by MEGA Hub when included at the top of your README.md

    To get an exhaustive reference of Spaces configuration, please visit https://mega.tensorplay.cn/docs/hub/spaces-config-reference#spaces-configuration-reference.
    ...
    Args:
        ...
        models (list[`str`], *optional*)
            List of models related to this Space. Should be a dataset ID found on https://mega.tensorplay.cn/models.
        datasets (`list[str]`, *optional*)
            List of datasets related to this Space. Should be a dataset ID found on https://mega.tensorplay.cn/datasets.
        tags (`list[str]`, *optional*)
    ...
    Example:
        ```python
        >>> from megatensors._hub import SpaceCardData
...
def model_index_to_eval_results(model_index: list[dict[str, Any]]) -> tuple[str, list[EvalResult]]:
    """Takes in a model index and returns the model name and a list of `megatensors._hub.EvalResult` objects.
    ...
    Returns:
        ...
        eval_results (`list[EvalResult]`):
            A list of `megatensors._hub.EvalResult` objects containing the metrics
            reported in the provided model_index.

    Example:
        ```python
        >>> from megatensors._hub.repocard_data import model_index_to_eval_results
...
def eval_results_to_model_index(model_name: str, eval_results: list[EvalResult]) -> list[dict[str, Any]]:
    """Takes in given model name and list of `megatensors._hub.EvalResult` and returns a
    ...
    Args:
        ...
        eval_results (`list[EvalResult]`):
            List of `megatensors._hub.EvalResult` objects containing the metrics to be
    ...
    Example:
        ```python
        >>> from megatensors._hub.repocard_data import eval_results_to_model_index, EvalResult
