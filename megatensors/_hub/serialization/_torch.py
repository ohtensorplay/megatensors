...
def save_torch_model(
    ...
    *,
    ...
    For more information about tensor sharing, check out [this guide](https://mega.tensorplay.cn/docs/safetensors/torch_shared_tensors).
    ...
    ```py
    >>> from megatensors._hub import save_torch_model
    ...
    # Load model back
    >>> from megatensors._hub import load_torch_model  # TODO
...
def save_torch_state_dict(
    ...
    *,
    ...
    ```py
    >>> from megatensors._hub import save_torch_state_dict
    >>> model = ... # A PyTorch model
...
def split_torch_state_dict_into_shards(
    ...
    *,
    ...
    >>> from megatensors._hub import split_torch_state_dict_into_shards
...
def load_torch_model(
    ...
    *,
    ...
    Example:
    ```python
    >>> from megatensors._hub import load_torch_model
    >>> model = ... # A PyTorch model
...
def load_state_dict_from_file(
    ...
    Example:
    ```python
    >>> from megatensors._hub import load_state_dict_from_file
    ...
    for shared in shareds:
        ...
        if not complete_names:
            raise RuntimeError(
                ...
                " https://mega.tensorplay.cn/docs/safetensors/torch_shared_tensors for more information. Or open an"
                " issue."
            )
