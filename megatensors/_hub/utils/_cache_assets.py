...
from ..constants import MEGA_ASSETS_CACHE
...
def cached_assets_path(
    ...
    *,
    ...
    `megatensors._hub` provides a canonical folder path to store assets. This is the
    ...
    Hub are cached in a git-aware manner and entirely managed by `megatensors._hub`. See
    [related documentation](https://mega.tensorplay.cn/docs/megatensors._hub/how-to-cache).
    ...
    subfolder. Those 3 levels grants flexibility while allowing `megatensors._hub` to
    ...
    Args:
        ...
        assets_dir (`str`, `Path`, *optional*):
            ...
            where Hub files are cached. Defaults to `MEGA_HOME / "assets"` if not provided.
            Can also be set with `MEGA_ASSETS_CACHE` environment variable.
    ...
    Example:
    ```py
    >>> from megatensors._hub import cached_assets_path

    >>> cached_assets_path(library_name="datasets", namespace="SQuAD", subfolder="download")
    PosixPath('/home/wauplin/.cache/mega/extra/datasets/SQuAD/download')

    >>> cached_assets_path(library_name="datasets", namespace="SQuAD", subfolder="extracted")
    PosixPath('/home/wauplin/.cache/mega/extra/datasets/SQuAD/extracted')

    >>> cached_assets_path(library_name="datasets", namespace="Helsinki-NLP/tatoeba_mt")
    PosixPath('/home/wauplin/.cache/mega/extra/datasets/Helsinki-NLP--tatoeba_mt/default')
