...
__all__ = ["AutoLoader", "MegaTensorsFileLoader", "ThreeFSLoader"]
...
_LOADER_REGISTRY: Dict[str, str] = {
    "base": "MegaTensorsFileLoader",
    "3fs": "ThreeFSLoader",
}


def _resolve_loader_class(loader_name: str) -> Type[BaseMegaTensorsFileLoader]:
