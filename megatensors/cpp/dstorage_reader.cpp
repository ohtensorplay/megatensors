...
static const GUID MEGA_IID_IDXGIFactory1 = {
    0x770aae78, 0xf26f, 0x4dba,
    {0xa8, 0x29, 0x25, 0x3c, 0x83, 0xd1, 0xb3, 0x87}
};
static const GUID MEGA_IID_ID3D12Device = {
    0x189819f1, 0x1db6, 0x4b57,
    {0xbe, 0x54, 0x18, 0x21, 0x33, 0x9b, 0x85, 0xf7}
};
static const GUID MEGA_IID_ID3D12Fence = {
    0x0a753dcf, 0xc4d8, 0x4b91,
    {0xad, 0xf6, 0xbe, 0x5a, 0x60, 0xd9, 0x5a, 0x76}
};
static const GUID MEGA_IID_ID3D12Resource = {
...
public:
    static bool Initialize(int device_id, uintptr_t provided_device, const std::string& dstorage_dll_dir) {
        ...
        if (provided_device) {
            ...
            HRESULT hr = g_pfnCreateDXGIFactory1(MEGA_IID_IDXGIFactory1, (void**)&factory);
            ...
            HRESULT hr2 = g_pfnD3D12CreateDevice(adapter, D3D_FEATURE_LEVEL_11_0, MEGA_IID_ID3D12Device, (void**)&s_device);
            adapter->Release();
...
public:
    ...
    dstorage_stream_reader() {
        ...
        hr = dev->CreateFence(0, D3D12_FENCE_FLAG_NONE,
                              MEGA_IID_ID3D12Fence, (void**)&fence_);
        if (FAILED(hr)) {
        ...
        for (int i = 0; i < 2; i++) {
            hr = dev->CreateCommittedResource(
                ...
                MEGA_IID_ID3D12Resource, (void**)&stage_res_[i]);
            if (FAILED(hr)) {
