...
from .loader import BaseMegaTensorsFileLoader, MegaTensorsFileLoader
...
class FileBatch:
    ...
    This class encapsulates a batch of megatensors files that have been loaded
    ...
    def __init__(self, fb, keys: List[str], batch_id: int):
        ...
        Args:
            fb: megatensors file buffer containing loaded tensors
            keys: List of tensor keys available in this batch
            batch_id: Unique identifier for this batch
        """
        self.fb = fb  # megatensors file buffer
...
class PipelineParallel:
    r"""Load .megatensors files in parallel with producer-consumer pattern."""

    def __init__(
        self,
        pg: Optional[Any],
        loader: BaseMegaTensorsFileLoader,
        ...
        **kwargs,
        ...
        # MegaTensorsFileLoader.set_tensor_filter. get_tensor broadcasts across
        ...
        self.print_log = os.getenv("MEGATENSORS_DEBUG", "false").lower() == "true"
    ...
    def _producer_worker(self):
        ...
        try:
            for f_list in tqdm(
                ...
                desc="Loading megatensors checkpoint shards",
                disable=True,
...
class ParallelLoader(PipelineParallel):
    ...
    the creation of the MegaTensorsFileLoader with appropriate parameters.

    Args:
        pg (Optional[Any]): Process group-like objects for distributed operations.
                           None for single GPU use-cases.
        hf_weights_files (List[str]): List of megatensors files to load.
        ...
        tensor_filter (Optional[Callable[[str], bool]]): If set, read only the
                         ...
                         MegaTensorsFileLoader.set_tensor_filter and
                         megatensors.ep_slice.expert_parallel_filter). Must
    ...
    Examples:
        >> from megatensors.parallel_loader import ParallelLoader
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize PipelineParallelLoader with a pre-configured MegaTensorsFileLoader.
