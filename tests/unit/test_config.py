...
"""Tests for megatensors.config module."""
...
from megatensors.config import (
    CONFIG_ENV_VAR,
    DEFAULT_CONFIG_PATH,
    LoaderConfig,
    load_config,
...
class TestLoadConfig:
    ...
    Priority order (high -> low):
      1. MEGATENSORS_CONFIG environment variable
      2. Default path (./megatensors.json)
    ...
    def test_no_config_uses_defaults(self, monkeypatch, tmp_path):
        ...
        (``./megatensors.json``) is guaranteed to be absent, regardless of
